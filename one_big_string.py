...
#A list of lists, where the inner lists are the columns (a “list of columns”),
#where y = 0 is the top of the grid.

#x coordinate is first index, y coordinate is second